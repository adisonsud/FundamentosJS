...
function operaciones(numA = 0, numB = 0) {
...
function operaArray(numA = 0, numB = 0) {
...
function operaObject(numA = 0, numB = 0) {
    return {
...
const sumarA = function (numX = 0, numY = 0) {
    return numX + numY;
};
...
formaUno();
//Forma 2
const formaDos = (numX = 0, numY = 0) => {
    console.log(numX + numY);
};
formaDos(12, 15);
//Forma 3
//Donde brillan mas los arrow function es en los return
const formaTres = (numX = 0, numY = 0) => {
    return numX + numY;
};
...
const formaCuatro = (numX = 0, numY = 0) => numX + numY;
